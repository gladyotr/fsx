...
while True:
    ...
    a = int(input(f'\nEnter your choice: {r}'))
    if a == 1:
        with open('touch config.data', 'ab') as g:
            newly_added = []
            while True:
                a = int(input(f'\n{lg}Enter API ID: {r}'))
                ...
                if 'y' in ab:
                    ...
                    print('\n'+lg+'[i] Saved all accounts in touch config.data'+n)
                    g.close()
                    sleep(3)
                    clr()
        ...
        if len(accounts) == 0:
            ...
            if len(banned_accs) == 0:
                ...
                for m in banned_accs:
                    accounts.remove(m)
                with open('touch config.data', 'wb') as k:
                    for a in accounts:
                        Id = a[0]
                        Hash = a[1]
                        Phone = a[2]
